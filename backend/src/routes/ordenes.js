...
router.post('/crear', verificarToken, async (req, res) => {
  try {
    const { direccion, ciudad, notas, nombre, telefono, tipoEnvio } = req.body
    if (!direccion) {
    ...
    const ordenes = await crearOrden(req.usuario.id, { direccion, ciudad, notas, nombre, telefono, tipoEnvio })
