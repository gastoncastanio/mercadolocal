...
export default function CentralVendedor() {
  ...
  const secciones = [
    ...
    { to: '/carritos-abandonados', icon: '\u{1F6D2}', titulo: 'Sin completar', desc: 'Compras sin pagar' },
    { to: '/promover', icon: '\u{1F4E2}', titulo: 'Publicidad', desc: 'Promocionar productos' },
    { to: '/mis-comprobantes', icon: '\u{1F9FE}', titulo: 'Facturación', desc: 'Comprobantes y datos fiscales' }
  ]
