      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        {ordenes.length === 0 ? (
          <div className="text-center py-20 bg-white rounded-2xl shadow-sm">
            ...
            <h3 className="text-xl font-semibold text-ml-ink mb-2">No hay compras abandonadas</h3>
            <p className="text-ml-muted">Todos tus compradores completaron el pago</p>
          </div>
        ) : (
              ...
              <div key={orden._id} className="bg-white rounded-xl shadow-sm p-6 border-l-4 border-orange-400">
                <div className="flex items-start justify-between mb-3">
                  <div>
                    ...
                    <p className="text-sm text-ml-muted">{orden.compradorId?.email}</p>
                ...
                <div className="border-t pt-3 flex items-center justify-between">
                  <span className="font-bold text-lg text-ml-ink">${orden.total.toLocaleString()}</span>
