      ...
      <div className="min-h-screen bg-ml-bg py-12 px-4">
        <div className="max-w-lg mx-auto">
          <div className="bg-gradient-to-br from-yellow-50 to-orange-50 border-2 border-orange-300 rounded-2xl shadow-lg p-8 text-center">
            ...
            <p className="text-ml-soft mb-6 text-sm">
            ...
            <p className="text-xs text-ml-muted mt-5">
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-sm border border-ml-line p-6 space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-ml-ink mb-2">
              Fotos del producto{' '}
              <span className="text-ml-muted font-normal">
                ...
                <div key={url + idx} className="relative aspect-square group">
                  ...
                  {idx !== 0 && (
                    <button
                      ...
                      className="absolute bottom-1 left-1 bg-white/90 text-ml-ink text-[10px] font-medium px-2 py-0.5 rounded-md shadow hover:bg-white opacity-0 group-hover:opacity-100 transition-opacity"
                ...
                <div
                  ...
                  className={`aspect-square border-2 border-dashed rounded-xl flex flex-col items-center justify-center transition-colors ${
                    subiendoActivo
                      ...
                      : 'border-ml-line hover:border-blue-500 hover:bg-blue-50 cursor-pointer'
                  }`}
                >
                  {subiendoActivo ? (
                    <div className="w-full px-2 text-center">
                      <div className="text-[11px] text-ml-ink mb-1.5 font-medium leading-tight">
                        {progresoImagen.mensaje}
                      </div>
                      <div className="w-full h-1.5 bg-ml-bg rounded-full overflow-hidden">
                        <div
                          className="h-full bg-blue-500 transition-all duration-300"
                          style={{ width: `${progresoImagen.porcentaje}%` }}
                        />
                      </div>
                      <div className="text-[10px] text-ml-muted mt-1">
                    ...
                    <>
                      ...
                      <span className="text-xs text-ml-muted font-medium text-center px-2">
                        Agregar foto
                      </span>
                    </>
                  )}
          ...
          <div>
            <label className="block text-sm font-medium text-ml-ink mb-1">Nombre del producto *</label>
            <input
              type="text"
              required
              value={form.nombre}
          ...
          <div>
            <label className="block text-sm font-medium text-ml-ink mb-1">Descripción</label>
            <textarea
          ...
          <div>
            ...
            <p className="text-xs text-ml-muted mb-3">Elegí la categoría que mejor describa tu producto.</p>
            ...
            {categoriaSeleccionada && !categoriaSeleccionada.permitePago && (
              <div className="mt-2 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                <p className="text-xs font-medium text-ml-ink">
