    ...
    >
      ...
      <div className="aspect-square bg-gray-100 relative overflow-hidden">
        ...
        {(producto as any).esDestacado && (
          <div className="absolute top-2 left-2 bg-gradient-to-r from-amber-400 to-orange-500 text-white text-[10px] font-bold px-2 py-1 rounded-full shadow-sm flex items-center gap-1">
            &#x2B50; Destacado
          </div>
        )}
        {producto.stock <= 0 && (
