    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div>
        ...
        <input
          ...
          maxLength={50}
          className="w-full px-4 py-2 border border-ml-line rounded-lg focus:ring-2 focus:ring-ml-purple/30 focus:border-transparent"
          disabled={loading}
        />
      </div>
      ...
      <div>
        ...
        <textarea
          ...
          disabled={loading}
        />
        <p className="text-sm text-ml-muted mt-1">{descripcion.length}/500</p>
      </div>
      ...
      <div>
        ...
        <p className="text-sm text-ml-soft mb-3">
          ...
          {valores.map((valor, index) => (
            <div key={index} className="flex gap-2">
              <input
                ...
                maxLength={30}
                className="flex-1 px-4 py-2 border border-ml-line rounded-lg focus:ring-2 focus:ring-ml-purple/30 focus:border-transparent"
                disabled={loading}
              />
              {valores.length > 1 && (
                <button
        ...
        <button
          ...
          className="mt-3 px-4 py-2 text-ml-blue hover:bg-blue-50 rounded-lg border border-blue-200"
          disabled={loading}
        >
          + Agregar valor
        </button>
