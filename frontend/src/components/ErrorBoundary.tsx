      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
          <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full text-center">
            ...
            <h1 className="text-2xl font-bold text-ml-ink mb-2">Algo no carga bien</h1>
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full py-3 border border-ml-line text-ml-ink rounded-xl font-medium hover:bg-gray-50 transition-all"
              >
                Ir al inicio
              </button>
            </div>
